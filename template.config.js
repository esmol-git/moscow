...
export default {
	...
	ftp: {
		host: '141.8.192.119',
		port: 21,
		// Путь относительно домашней папки FTP (/domains/antalya-house.ru). Без ведущего слэша — иначе сервер может разорвать соединение (ECONNRESET).
		remoteDir: 'public_html/',
		user: 'a0284531@a0284531',
		password: 'ZAQwsx1984',
		// Пассивный режим — часто нужен за NAT/фаерволом, иначе возможен ECONNRESET.
		forcePasv: true,
	},
	logger: {
